...
- **벡터 검색**: Chroma(DB)를 이용한 고속 유사도 검색
...
# 또는 pip 직접 사용
pip install python-dotenv langchain langchain-openai langchain-community pypdf gradio gradio-pdf chromadb
```
...
- [Chroma DB](https://www.trychroma.com/) - 벡터 저장소/검색 엔진
